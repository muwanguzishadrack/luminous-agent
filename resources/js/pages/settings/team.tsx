...
import { edit, update } from '@/routes/team';
...
export default function TeamSettings({
    ...
    // The user's single team is a shared prop — the page names no team (D-020).
    const team = usePage().props.team;
    ...
    return (
        <>
            ...
            <div className="flex flex-col space-y-10">
                ...
                {permissions.canDeleteTeam && team ? (
                    <div className="space-y-6">
                        <Heading
                            variant="small"
                            title="Delete team"
