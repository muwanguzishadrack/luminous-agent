...
export default function TenantEdit({
    ...
    const pageTitle = useMemo(
        () =>
            permissions.canUpdateTenant
                ? `Edit ${tenant.name}`
                : `View ${tenant.name}`,
        [permissions.canUpdateTenant, tenant.name],
    );

    const updateMemberRole = (member: TenantMember, newRole: string) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col space-y-10">
                    ...
                    {permissions.canUpdateTenant ? (
                        <>
                            <Heading
                                ...
                                description="Update your tenant name and settings"
                            />
                        ...
                        <Heading
                            ...
                            description={
                                permissions.canCreateInvitation
                                    ? 'Manage who belongs to this tenant'
                                    : ''
                            }
                        />
                ...
                {permissions.canDeleteTenant && !tenant.isPersonal ? (
                    <div className="space-y-6">
                        <Heading
                            variant="small"
                            title="Delete tenant"
                            description="Permanently delete your tenant"
                        />
...
TenantEdit.layout = (props: { tenant: { name: string; slug: string } }) => ({
    breadcrumbs: [
        {
            title: 'Tenants',
            href: index(),
