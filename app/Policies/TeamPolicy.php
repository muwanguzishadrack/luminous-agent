...
class TeamPolicy
{
    ...
    /**
     * Determine whether the user can edit the WhatsApp business profile or
     * disconnect the team's number — owners and admins only
     * (docs/modules/m0-onboarding.md §7).
     */
    public function manageWhatsApp(User $user, Team $team): bool
    {
        return $user->hasTeamPermission($team, TeamPermission::ManageWhatsApp);
    }
